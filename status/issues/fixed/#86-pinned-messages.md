...
## Тесты
- `test/pin.test.ts` — полный прогон pin/unpin: 401/400/404 (не-участник,
  чужое сообщение, сообщение из другого чата, удалённое), замена при
  повторном закреплении, идемпотентное открепление, ChatView у всех
  участников, fan-out `chat.pinned` в outbox (строка на участника),
  live-доставка по WS и закрепление в группе.
  Написаны без запуска (в среде разработки нет Postgres) — прогнать на
  стеке run/dev.
